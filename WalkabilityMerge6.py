...
if __name__ == '__main__':
    ...
    for countyfolder in countyFolderList:
        try:
            ...
            countyBufferedDestination[countyfolder] = createBufferedCountyDestinationsDW(outdir, countyFC, mergedMetroDestinations, countyfolder)
    ...
    for countyfolder in countyFolderList:
        try:
            ...
            featureClass = fc.split('.')[0]
            parcelsFC = featureClass +  countyfolder
            zips = getCountyZIPS(parcelsFC,"SIT_ZIP")
            print zips
            #zips = [str(zp) for zp in zips1 if len(zp) > 4]
            #zips = zips2[:3]
            ...
            for zip in zips:
                ...
                try:
                    ...
                    outputName = scoreParcelsDW(zipFeature,bufferedCountyDestinations, geoDataBaseName,zip)
