...
if __name__ == '__main__':
    ...
    for countyfolder in countyFolderList:
        try:
            ...
            featureClass = fc.split('.')[0]
            parcelsFC = destinationsPath + geoDataBaseName + "\\" + featureClass +  countyfolder
            removeFields3(countyfolder,parcelsFC)
            bufferedCountyDestinations = countyBufferedDestination[countyfolder]
            removeFields3(countyfolder,bufferedCountyDestinations)
            scoredParcels = scoreParcelsDW(parcelsFC,bufferedCountyDestinations, outputName, geoDataBaseName)
            ...
            print "Failed ",parcelsFC, e.message
